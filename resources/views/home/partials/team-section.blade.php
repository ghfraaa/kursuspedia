<section id="team" class="px-8 bg-blue-50">
        <div class="py-12">
            <div class="mb-12 text-center lg:text-left">
                <h2 class="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">Kenalan Dengan <span
                        class="text-indigo-600">Tim Hebat Kami.</span></h2>
            </div>
                ...
                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                            src="{{ asset('image/tim/jeje.jpg') }}"  alt="Mentor 1">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Chief Executive Officer (CEO)</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/ghefira.jpg') }}" alt="Mentor 2">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Chief Creative Officer (CCO)</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/dila.jpg') }}"alt="Mentor 2">
                        <a href="#"
                            class="absolute bottom-2 right-2 flex items-center justify-center flex items-center justify-center bg-indigo-600 text-white w-8 h-8 rounded-full hover:bg-indigo-700 transition-colors">
                            <i class="fa-brands fa-instagram"></i>
                            <span class="sr-only">Instagram</span>
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Head of Curriculum & Learning</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/melda.jpg') }}" alt="Mentor 2">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Head of Quality & Feedback</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/fahmi.jpg') }}" alt="Mentor 2">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Frontend Lead Engineer</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/noval.jpg') }}" alt="Mentor 2">
                        <a href="#"
                            class="absolute bottom-2 right-2 flex items-center justify-center flex items-center justify-center bg-indigo-600 text-white w-8 h-8 rounded-full hover:bg-indigo-700 transition-colors">
                            <i class="fa-brands fa-instagram"></i>
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Backend Systems Architect</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/kevin.jpg') }}" alt="Mentor 2">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Data & Security Officer</p>
                </div>

                <div class="flex flex-col items-center text-center">
                    <div class="relative mb-4">
                        <img class="w-40 h-40 rounded-full object-cover ring-4 ring-indigo-200"
                             src="{{ asset('image/tim/dani.jpg') }}" alt="Mentor 3">
                    ...
                    <p class="text-indigo-600 text-sm font-semibold">Infrastructure & DevOps Lead</p>
                </div>
            </div>
        </div>
    </section>