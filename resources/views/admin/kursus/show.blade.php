    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row items-start md:justify-between mb-4">
                        <div class="w-full md:w-auto mb-4 md:mb-0"> {{-- Tambahkan lebar dan margin responsif --}}
                            <h2 class="text-2xl font-bold text-gray-900 mb-2">{{ $kursus->nama }}</h2>
                            <div class="flex flex-wrap items-center space-x-2 md:space-x-4 text-sm text-gray-600"> {{-- Tambah flex-wrap untuk mobile --}}
                                ...
                                {{-- Bagian Grup WA --}}
                                @if($kursus->grupwa_link)
                                    <a href="{{ $kursus->grupwa_link }}" target="_blank" class="flex items-center mt-2 md:mt-0 text-sm text-blue-600 hover:underline">
                        ...
                        <div class="w-full md:w-auto text-left md:text-right"> {{-- Sesuaikan lebar dan perataan teks --}}
